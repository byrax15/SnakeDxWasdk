...
void SnakeDx::Resources::SetSwapChainPanel(winrt::Windows::UI::Xaml::Controls::SwapChainPanel panel, winrt::Windows::Foundation::Size newSize)
{
...
void SnakeDx::Resources::CreateDeviceResources()
{
